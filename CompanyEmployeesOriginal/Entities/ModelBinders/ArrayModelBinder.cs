        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            */
             ...
             * In the genericType variable, with the reflection help, we store the type 
                the IEnumerable consists of. In our case, it is GUID.
             */
            var genericType = bindingContext.ModelType.GetTypeInfo().GenericTypeArguments[0];
            /**
             * 
             * With the converter variable, we create a converter to a GUID type. As you can 
            ...
            */
            ...
            /**
             *  we create an array of type object (objectArray) that consist 
